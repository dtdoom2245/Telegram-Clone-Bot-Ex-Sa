...
REPO_LINK = "https://github.com/dtdoom2245/Telegram-Clone-Bot-Ex-Sa"
# Soon to be used for direct updates from within the bot.

@run_async
def start(update, context):
    sendMessage("Hello! Please send me a Google Drive Shareable Link to Clone to your Drive! Owner by @DoubleT2245" \
    ...
    while not status.done():
        ...
        try:
            ...
            if status.checkFileStatus():
                text += f"\n🕒 *ရှိပြီးသားဖိုင်များကိုစစ်ဆေးခြင်:* `{str(status.checkFileStatus())}`"
